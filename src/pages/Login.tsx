    ...
    <div className="min-h-screen gradient-hero">
      <div className="container max-w-md mx-auto px-4 pt-8 pb-8">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          {isLogin ? (
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-sm text-coral font-medium">
                Forgot Password?
              </button>
            </div>
          ) : (
        ...
        <div className="flex gap-4">
          <button className="flex-1 py-3 rounded-xl border border-border bg-white flex items-center justify-center gap-2 hover:bg-secondary transition-colors">
