...
const Support = () => {
  ...
  return (
    <div className="min-h-screen bg-background lg:pb-0 pb-[48px]">
      <Header />
        ...
        <div className="container max-w-5xl mx-auto px-4">
          <div className="text-center">
            <div className="w-20 h-20 mx-auto mb-4 overflow-hidden flex items-center justify-center">
              <img src={logoUrl || rcJoyLogo} alt="Logo" className="w-full h-full object-contain" />
            </div>
                ...
                <CardContent className="space-y-2">
                  {Object.entries(businessHours).map(([title, hours]) => (
                    <div key={title} className="flex justify-between text-sm">
                      ...
                      <span
                        className={`font-medium ${hours.toLowerCase() === "closed" ? "text-destructive" : "text-foreground"}`}
                      >
                        {hours}
                      </span>
                    </div>
            ...
            {faqs.length > 0 && (
              <div>
                ...
                <div className="space-y-3">
                  {faqs.map((faq) => (
                    <Card key={faq.id} className="glass-card border-0 shadow-soft overflow-hidden">
                      <button
                      ...
                      >
                        ...
                        <div
                          className={`w-8 h-8 rounded-full bg-muted flex items-center justify-center flex-shrink-0 transition-transform ${expandedFaq === faq.id ? "rotate-180" : ""}`}
                        >
            ...
            <div className="sticky top-20 space-y-6">
              ...
              <Card className="glass-card border-0 shadow-soft">
                <CardContent className="p-5 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Our team is ready to assist you</p>
                  {contactInfo.phone && (
                    <a
                      href={`tel:${contactInfo.phone.replace(/\s/g, "")}`}
